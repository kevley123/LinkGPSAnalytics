...
export default function Dashboard() {
  ...
  return (
    <div className="relative h-[calc(100vh-120px)] w-full overflow-hidden rounded-[40px] border-4 border-black bg-black shadow-3xl">
      ...
      {/* ── Background Map (Ultra Dark with Pure Black Lines) ────────────────── */}
      ...
      >
        <div className="bg-black border border-white/5 rounded-[32px] p-6 shadow-2xl">
          <h3 className="text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] mb-8 text-center border-b border-white/5 pb-4">Matrix IA</h3>
          ...
          <div className="space-y-6">
            <div className="group">
              ...
              <p className="text-[8px] text-neutral-500 uppercase font-bold tracking-tighter">Eventos SOS activos</p>
            </div>
            ...
            <div className="group">
              ...
              <p className="text-[8px] text-neutral-500 uppercase font-bold tracking-tighter">Desvíos detectados hoy</p>
            </div>
            ...
            <div className="group">
              ...
              <p className="text-[8px] text-neutral-500 uppercase font-bold tracking-tighter">Ruta Nacional IA</p>
            </div>
          </div>
        </div>
      ...
      {/* ── Compact Risk Tech (Transparent Cream Orange) ────────────────────── */}
      <motion.div
        initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}
        className="absolute bottom-8 left-8 z-10 w-72 pointer-events-auto"
      >
        <div className="bg-orange-200/10 backdrop-blur-xl border border-orange-200/20 rounded-2xl p-4 flex flex-col gap-2 shadow-2xl">
          ...
          <p className="text-white/60 text-[9px] leading-relaxed font-medium">
